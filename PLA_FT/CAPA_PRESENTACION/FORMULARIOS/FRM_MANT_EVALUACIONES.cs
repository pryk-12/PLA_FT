...
namespace CAPA_PRESENTACION.FORMULARIOS
{
    public partial class FRM_MANT_EVALUACIONES : CAPA_PRESENTACION.FORMULARIOS.FRM_PLANTILLA
    {
        ...
        {
            string CONDICION = "(A.ID_CLIENTE LIKE'%" + txt_buscar.Text + "%' OR B.NOMBRES LIKE'%" + txt_buscar.Text + "%' OR B.APELLIDO_PAT LIKE'%" + txt_buscar.Text + "%' OR B.APELLIDO_MAT LIKE'%" + txt_buscar.Text + "%') ORDER BY A.ID_EVALUACION DESC";
