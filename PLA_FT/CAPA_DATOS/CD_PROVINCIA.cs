   ...
   public class CD_PROVINCIA
    {
        ...
        {
            cn.Close();
            da.SelectCommand = new SqlCommand("SP_PROVINCIAS", cn);
        ...
        public void INSERTAR(CE_PROVINCIA obj)
        {
            cn.Close();
            da.InsertCommand = new SqlCommand("SP_PROVINCIAS", cn);
        ...
        public void ACTUALIZAR(CE_PROVINCIA obj)
        {
            cn.Close();
            da.UpdateCommand = new SqlCommand("SP_PROVINCIAS", cn);
